...
SR_ENG_TO_SP = {"random":"azar", "distance":"distancia","time":"tiempo"}
SR_SP_TO_ENG = {v:k for (k, v) in SR_ENG_TO_SP.items()}
...
default_parameters = {'CITY_TYPE': 'square', 'RB_LENGTH': 8, 'AV_LENGTH': 44, 'INTERSEC_LENGTH': 3, \
                    ...
                    'ST_CENTRAL':0, 'ST_DISTRIBUTED': 1, 'ST_FOUR': 0,'SR_DISTANCE':0, 'REPETITIONS': 1, \
